...
INSERT INTO checkpoints
values
    (6, 'Task: Create another repository', '
...
INSERT INTO checkpoints
values
    (7, 'Quiz: Clone another user repo', '
    <div class="form-group">
    ...
    <label for="question">What is the command that you would enter to clone a repository with name test from user karan-bamboozled</label>
...
INSERT INTO checkpoints
values
    (8, 'Quiz: Change remote address', '
    <div class="form-group">
    <div class="form-text"> Remote urls tell git the location to push and pull from, since you have cloned from karan-bamboozled test repository, whenever you push the changes to remote, it will be reflected in his repository(forbidden), so remove the present remote address and make the remote point to your repository which you just created</div>
...
values
    ...
    Fork a repository called lcc from karan-bamboozled https://github.com/karan-bamboozled/lcc 
...
INSERT INTO checkpoints
values
    (11, 'Task: Add you name and commit (web)', 'You can modify the files in the web by clicking on that file and clicking on the edit icon
...
INSERT INTO checkpoints
values
    (12, 'Task: Add you name and commit (cli) ', ' Clone this repository in a different folder (not in the present git folder) and
...
INSERT INTO checkpoints
values
    (13, 'Task: Make a Pull request ', 'Time to make your contribution to the repository of karan-bamboozled, Add all the changes that you have made in your forked repository to his repository by creating a pull request( Requesting karan-bamboozled to pull changes in your repository, simple as that )
...
INSERT INTO checkpoints
values
    (14, 'Task: Accepting the pull request by user', 'Now what next? Wait for the user karan-bamboozled to accept your pull request and merge the changes! Ask your administrator to accept the pull request
...
INSERT INTO checkpoints
values
    (15, 'Task: Create another branch', 'Create a new branch in your repo, not the first repository but the one with helloworld.py file
...
INSERT INTO checkpoints
values
    (16, 'Task: Modify the branch', 'Now insert your branch name in the file. branch names are case sensitive!<small class="form-text text-muted">This is you tesing out new features in your app in real world!</small>','check_branch_commit', 10);

INSERT INTO checkpoints
values
    (17, 'Task: Create a pull request to update master branch', 'Since your new feature is now working good, you should merge the changes on this new branch to the master branch<small class="form-text text-muted">You must create pull requests to merge changes to your own repositorys master branch</small>','check_branch_pull_request', 10);

INSERT INTO checkpoints
values
    (18, 'Task: Accept the pull request to update master branch', 'You can merge the two branches by acceptin the pull request <small class="form-text text-muted">Make sure that you have not changed the default merge message, or else you will have to do this again!</small>','accept_branch_pull_request', 10);

INSERT INTO checkpoints
values
    (19, 'Task: delete branch', 'Delete the branch you have created, as changes have been merged to master branch!<small class="form-text text-muted">branches help you to test out new features for the perfectly working application withot breaking the main application</small>','check_delete_branch', 10);

INSERT INTO checkpoints
values
    (20, 'Quiz: Update local repository', '<div class="form-group">
...
INSERT INTO checkpoints
values
    (21, 'Quiz: Create another branch locally','<div class="form-group">
...
INSERT INTO checkpoints
values
    (22, 'Quiz: Work in cli branch locally','<div class="form-group">
...
INSERT INTO checkpoints
values
    (23, 'Quiz: Modify, commit and merge','<div class="form-group">
...
INSERT INTO checkpoints
values
    (24, 'Task: Push the changes to remote','All the changes you have made is on the local repository, to make the changes reflected on the remote repository, push the changes to remote<small class="text-muted">git push is used to push the local changes to remote repository</small>','check_branch_master', 10);

INSERT INTO checkpoints
values
    (25, 'Task: Delete the second repository repository that you have created','Delete the repository that you created for the second time','check_delete_repo', 10);
